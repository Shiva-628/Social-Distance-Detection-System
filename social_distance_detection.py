...
import argparse #Argument Parse
...
arg.add_argument('-v', '--video', type = str, default = 'PETS2009.avi', help = 'Video file path. If no path is given, video is captured using device.')
...
while cap.isOpened():
    ...
    blob = cv2.dnn.blobFromImage(cv2.resize(frame, (300, 300)), 0.007843, (300, 300), 127.5) #mean subtraction, normalizing, and channel swapping
